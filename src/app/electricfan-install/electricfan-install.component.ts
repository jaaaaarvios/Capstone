...
@Component({
  selector: 'app-electricfan-install',
  templateUrl: './electricfan-install.component.html',
  styleUrls: ['./electricfan-install.component.css']
})
export class ElectricfanInstallComponent implements OnInit {
