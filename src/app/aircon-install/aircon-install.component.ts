...
@Component({
  selector: 'app-aircon-install',
  templateUrl: './aircon-install.component.html',
  styleUrls: ['./aircon-install.component.css']
})
export class AirconInstallComponent implements OnInit {
  ...
  openDialog() {
    const dialogRef = this.dialog.open(InstallFeeComponent);
