...
@Component({
  selector: 'app-television-cleaning',
  templateUrl: './television-cleaning.component.html',
  styleUrls: ['./television-cleaning.component.css']
})
export class TelevisionCleaningComponent implements OnInit {
