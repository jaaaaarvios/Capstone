...
@Component({
  selector: 'app-refrigerator-cleaning',
  templateUrl: './refrigerator-cleaning.component.html',
  styleUrls: ['./refrigerator-cleaning.component.css']
})
export class RefrigeratorCleaningComponent implements OnInit {
