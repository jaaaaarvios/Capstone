...
@Component({
  selector: 'app-refrigerator-install',
  templateUrl: './refrigerator-install.component.html',
  styleUrls: ['./refrigerator-install.component.css']
})
export class RefrigeratorInstallComponent implements OnInit {
