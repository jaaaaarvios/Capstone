...
@Component({
  selector: 'app-electricfan-cleaning',
  templateUrl: './electricfan-cleaning.component.html',
  styleUrls: ['./electricfan-cleaning.component.css']
})
export class ElectricfanCleaningComponent implements OnInit {
